...
//@Getter
//@Setter
@Data // with this annotation we will get the required annotation like getter,setter,toString,etc
@NoArgsConstructor
public class JournalEntry {


    // This class is also known as POJO class --> Plain Old Java Object
    @Id
    private ObjectId id;
    @NonNull
